---
title: "GLOE-Seq analysis CTCF binding sites and DHS"
...
embed_last_plot("profile-ctcf-atac-dhs")
```
...
embed_last_plot("profile-ctcf-pos")
```
...
ggarrange(p1, p2, p3, p4, p5, p6, ncol = 3, nrow = 2)
embed_last_plot("profile-dhs-pos")
```

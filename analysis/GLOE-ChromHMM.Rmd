...
plot_bw_loci_summary_heatmap(fn$files,"../genome/Thompson2018_HCT116_WT_ChromHMM10.chr3.bed",labels = fn$labels, aggregate_by = "mean", remove_top = 0.0001, verbose = F)

embed_last_plot('chromhmm')
embed_last_data('chromhmm')
```

## ChromHMM replicates
```{r fig.width = 4, fig.height = 8}
fn <- build_filenames(data_path,replicates)
